...
# XXX export ACTIVEMQ_SUNJMX_START="-javaagent:$ACTIVEMQ_HOME/jmx_prometheus_javaagent-0.15.0.jar=5556:$ACTIVEMQ_HOME/jmx-prometheus-config.yaml"

$ACTIVEMQ_HOME/bin/activemq console -javaagent:$ACTIVEMQ_HOME/jmx_prometheus_javaagent-0.15.0.jar=5556:$ACTIVEMQ_HOME/jmx-prometheus-config.yaml
