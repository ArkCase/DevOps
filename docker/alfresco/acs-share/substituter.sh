...
echo "Replace 'REPO_PROTO' with '$REPO_PROTO', 'REPO_HOST' with '$REPO_HOST' and 'REPO_PORT' with '$REPO_PORT'"

sed -i -e 's|REPO_PROTO://REPO_HOST:REPO_PORT|'"$REPO_PROTO://$REPO_HOST:$REPO_PORT"'|g' /usr/local/tomcat/shared/classes/alfresco/web-extension/share-config-custom.xml
